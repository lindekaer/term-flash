...
import { runQuiz, runAdd } from './quiz'
...
class CLI {
  ...
  displayHelp () {
    ...
    console.log(chalk.dim('> flash-term quiz -d history -n 20'))
    console.log(chalk.dim('> flash-term add -d history -q "When was the French revolution?" -a "1789"'))
